...
public class MaximumnergyBoost {
	 ...
	 * 
	 * Drink the energy drink A for the first hour. Switch to the energy drink B and
	 * we lose the energy boost of the second hour. Gain the energy boost of the
	 * drink B in the third hour.
	 */
