...
public class CountSubStrings2 {
	...
	/*
	 * Q4. Count Substrings That Satisfy K-Constraint II Hard 6 pt. You are given a
	 * binary string s and an integer k.
	 * 
	 ...
	 * conditions holds:
	 * 
	 * The number of 0's in the string is at most k. The number of 1's in the string
	 * is at most k. Return an integer array answer, where answer[i] is the number
	 * of substrings of s[li..ri] that satisfy the k-constraint.
	 * 
	 * 
	 * 
	 * Example 1:
